...
*Bu repoyu kötü niyetle kullanırsan bundan sorumlu değilim; tüm sorumluluk sana aittir.*
------------------------------------------------------------------------------------------
ENGLİSH
...
→ Download the latest release, grab the `adafruit_hid` folder inside
...
dont know how to code it no problem look at the "coding.md" file*
